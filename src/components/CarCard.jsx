import { assets, currencySymbol } from "../assets/assets"
import { useNavigate } from "react-router-dom"

const CarCard = ({car}) => {

  const currency = currencySymbol[car.currency];
  const navigate = useNavigate();

  return (
    <div onClick={() => {navigate(`/car-details/${car._id}`); scrollTo(0,0)}} className="group rounded-1 overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer">
